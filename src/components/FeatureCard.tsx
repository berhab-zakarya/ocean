...
const FeatureCard: FC<FeatureCardProps> = ({ title, imageUrl, content }) => {
  return (
    <article className="w-full md:max-w-[30rem] lg:max-w-[36rem] border-2 border-transparent rounded-lg py-4 px-8 hover:border-sky-600 cursor-pointer">
      <article className="flex flex-col items-center md:items-start lg:flex-row gap-6">
